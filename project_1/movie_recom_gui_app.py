...
ttk.Button(app,text='Find Reommendation',font=('Ariel',22),command=get_movie).place(x=10,y=250)
ttk.Label(app,textvariable=result,font=('Ariel',22)).place(x=10,y=350)
