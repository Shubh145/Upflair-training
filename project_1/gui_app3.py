...
ttk.Button(app,text='Find Reommendation',font=('Ariel',22),command=get_movie).place(x=350,y=10)
ttk.Label(app,textvariable=result,font=('Ariel',22),command=get_movie).place(x=10,y=300)
